...
final class StartTimerOverlay {
  static Future<void> showTimerConfirmationDialog(BuildContext parentContext) {
            ...
            builder: (context, state) {
              return AlertDialog(
                ...
                content: Text(
                    ...
                    '\nBiztosan most szeretnéd elindítani a számlálót? \nA számláló elindításával a kezdési időpontot már nem lehet megváltoztatni.',
                      ...
                      TextButton(
                            ...
                            .copyWith(
                                backgroundColor:
                                    MaterialStateProperty.all<Color>(
                                        kisgeri_design
                                            .Figma.colors.backgroundColor),
                                fixedSize: MaterialStateProperty.all<Size>(
                                    const Size(203, 35))),
                        onPressed: () {
                          context
                              .read<OverviewBloc>()
                              .add(LoadDataEvent.withTimer(calculateEndTime(null /* TODO: replace with timer value from context/dto */)));
                        ...
                        child: Text(
                            ...
                            style: kisgeri_design.Figma.typo.preTitle.copyWith(
                                color: kisgeri_design
                                    .Figma.colors.secondaryColor)),
                      ),
                      TextButton(
  ...
  static int calculateEndTime(int? timer) {
    // get the team's category, and based on that, calculate the end time
    // (since this dialog comes only for teams that are representing themself not in the 24h category)
    if (timer != null) {
